...
class TestSmoketestsuite():
  ...
  def test_test4JoinPageDataEntry(self):
    ...
    self.driver.find_element(By.NAME, "fname").send_keys("ebenezer")
    self.driver.find_element(By.NAME, "lname").click()
    self.driver.find_element(By.NAME, "lname").send_keys("mensah")
    self.driver.find_element(By.NAME, "bizname").click()
    self.driver.find_element(By.NAME, "bizname").send_keys("cedi")
    self.driver.find_element(By.NAME, "biztitle").click()
    self.driver.find_element(By.NAME, "biztitle").send_keys("the boss")
  ...
  def test_test5AdminPageUsernamePassword(self):
    ...
    assert len(elements) > 0
    self.driver.find_element(By.ID, "username").send_keys("free")
    self.driver.find_element(By.ID, "password").click()
    self.driver.find_element(By.ID, "password").send_keys("ghygbkn")
